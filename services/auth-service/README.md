...
The Authentication Service is a fundamental component of the Piggy Bank system, responsible for user registration, authentication, and session management.

## Overview

This microservice manages user identity and access within Piggy Bank. It provides secure user registration, login capabilities, and token-based authentication using JWT (JSON Web Tokens) with Redis-backed session management.
