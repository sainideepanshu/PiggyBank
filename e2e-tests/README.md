# End-to-End Tests for Piggy Bank Microservices

This folder contains end-to-end tests for the Piggy Bank microservices architecture, testing the complete flow across all services:
